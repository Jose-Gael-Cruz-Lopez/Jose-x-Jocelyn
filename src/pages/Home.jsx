...
const SEARCH_INDEX = [
  { label: 'About', description: 'Who we are & our story', type: 'section', target: '#about',
    keywords: ['who we are', 'about us', 'our story', 'jose', 'jocelyn', 'founders', 'first gen', 'first generation', 'mexican american', 'latino', 'hispanic', 'latinx', 'immigrants', 'underrepresented', 'diversity', 'inclusion', 'mission', 'vision', 'values', 'why', 'purpose', 'background', 'journey', 'team', 'people', 'real', 'authentic'] },
  { label: 'Services', description: 'All services overview', type: 'section', target: '#services',
    keywords: ['services', 'offerings', 'programs', 'what we do', 'help', 'resources', 'tools', 'features', 'overview', 'all', 'everything', 'platform', 'career help', 'career support', 'support', 'what do you offer', 'how can you help'] },
  { label: 'La Voz del Día', description: 'Daily editorial & career insights', type: 'section', target: '#editorial',
    keywords: ['la voz', 'voz', 'blog', 'articles', 'article', 'editorial', 'daily', 'insights', 'reads', 'reading', 'posts', 'post', 'news', 'writing', 'content', 'career content', 'tips', 'advice', 'guides', 'how to', 'stories', 'perspectives', 'featured', 'latest', 'recent', 'subscribe', 'newsletter', 'digest'] },
  { label: 'LinkedIn Series', description: 'Content · LinkedIn growth tips', type: 'page', to: '/linkedin-series',
    keywords: ['linkedin', 'social media', 'profile', 'optimize', 'optimization', 'headline', 'summary', 'about section', 'connections', 'followers', 'posts', 'content', 'writing', 'thought leadership', 'personal brand', 'branding', 'visibility', 'reach', 'algorithm', 'engagement', 'networking online', 'online presence', 'digital presence', 'get noticed', 'recruiter', 'series', 'episodes', 'tips', 'tricks', 'guide'] },
  { label: 'Career Templates', description: 'Content · Plug-and-play career docs', type: 'page', to: '/career-templates',
    keywords: ['templates', 'template', 'resume template', 'cover letter', 'cover letter template', 'email template', 'thank you email', 'follow up', 'follow up email', 'cold email', 'cold outreach', 'linkedin message', 'negotiation', 'salary negotiation', 'offer negotiation', 'tracker', 'job tracker', 'application tracker', 'career tracker', 'spreadsheet', 'documents', 'docs', 'google doc', 'notion', 'free', 'download', 'resources', 'tools', 'scripts', 'plug and play', 'copy paste', 'materials'] },
  { label: 'Bridge Year Sprint', description: 'Sprints · Bridge year program', type: 'page', to: '/bridge-year',
    keywords: ['bridge year', 'gap year', 'underclassmen', 'freshman', 'freshmen', 'sophomore', 'junior', 'first year', 'second year', 'third year', 'early career', 'beginner', 'new to tech', 'just starting', 'getting started', 'start', 'foundation', 'program', 'cohort', 'sprint', 'accountability', 'first gen', 'nontraditional', 'career switcher', 'pivot', 'lost', 'confused', 'dont know where to start', 'roadmap', 'plan', 'career plan', 'explore', 'discover', 'next steps', 'what should i do', 'where to begin', 'early stage'] },
  { label: 'Interview Prep', description: 'Sprints · Interview preparation', type: 'page', to: '/interview-prep',
    keywords: ['interview', 'interviews', 'prep', 'preparation', 'prepare', 'practice', 'mock', 'mock interview', 'behavioral', 'technical', 'technical interview', 'coding', 'coding interview', 'algorithm', 'data structure', 'system design', 'leetcode', 'leet code', 'hackerrank', 'star method', 'faang', 'big tech', 'startup', 'product interview', 'pm interview', 'design interview', 'underclassmen', 'new grad', 'new graduate', 'entry level', 'tips', 'how to', 'guide', 'nervous', 'anxiety', 'confidence', 'offer', 'rejection', 'phone screen', 'virtual interview', 'zoom interview', 'questions', 'common questions', 'tell me about yourself', 'strengths', 'weaknesses', 'internship interview', 'job interview', 'return offer', 'intern'] },
  { label: 'Opportunity Board', description: 'Community · Jobs & internships', type: 'page', to: '/opportunity-board',
    keywords: ['jobs', 'job', 'internship', 'internships', 'opportunities', 'opportunity', 'new grad', 'new graduate', 'entry level', 'junior', 'hiring', 'recruiting', 'recruiter', 'full time', 'fulltime', 'part time', 'summer', 'summer internship', 'co-op', 'coop', 'role', 'position', 'opening', 'work', 'employment', 'company', 'application', 'apply', 'job board', 'job search', 'job hunting', 'find a job', 'find work', 'career opportunities', 'tech job', 'software engineer', 'swe', 'product manager', 'pm', 'data science', 'ux', 'design', 'marketing', 'finance', 'consulting', 'first job', 'post grad', 'after college', 'after graduation', 'salary', 'compensation', 'remote', 'hybrid', 'onsite', 'visa', 'sponsorship', 'opt', 'cpt'] },
  { label: 'Coffee Chat Network', description: 'Community · Connect with professionals', type: 'page', to: '/coffee-chat',
    keywords: ['coffee chat', 'coffee chats', 'networking', 'network', 'connect', 'connection', 'mentor', 'mentorship', 'mentoring', 'professional', 'professionals', 'industry', 'informational interview', 'info chat', 'meet', 'meeting', 'talk', 'chat', 'conversation', 'advice', 'guidance', 'career advice', 'reach out', 'cold email', 'linkedin message', 'alumni', 'alum', 'community', 'people', 'relationship', 'professional development', 'professional network', 'peers', 'recruiter', 'employee', 'talk to someone in the industry', 'get advice', 'career guidance'] },
  { label: 'Resume Reviews', description: 'Community · Get your resume reviewed', type: 'page', to: '/resume-reviews',
    keywords: ['resume', 'resumes', 'cv', 'curriculum vitae', 'review', 'reviews', 'feedback', 'critique', 'help', 'improve', 'fix', 'check', 'proofread', 'edit', 'polish', 'ats', 'applicant tracking', 'format', 'formatting', 'skills', 'bullet points', 'action verbs', 'quantify', 'accomplishments', 'projects', 'college resume', 'student resume', 'new grad resume', 'tech resume', 'software engineer resume', 'internship resume', 'get reviewed', 'resume help', 'resume tips', 'one page', 'two page', 'entry level resume', 'first resume'] },
  { label: 'Partner Panels', description: 'Community · Live panels with partners', type: 'page', to: '/partner-panels',
    keywords: ['panel', 'panels', 'event', 'events', 'live', 'live event', 'webinar', 'talk', 'speaker', 'speakers', 'industry talk', 'recording', 'recordings', 'watch', 'listen', 'video', 'presentation', 'fireside chat', 'q&a', 'qa', 'discussion', 'partners', 'partner', 'company talk', 'recruiter panel', 'alumni panel', 'career panel', 'virtual event', 'workshop', 'seminar', 'past events', 'archive', 'rsvp', 'upcoming', 'schedule', 'register'] },
]
