      ...
      <section className="ob-source" id="source">
        ...
        <div className="ob-source__layout">
          ...
          <div className="ob-source__list">
            {[
              { icon: '📣', style: {}, title: 'J&J LinkedIn posts', desc: 'Jose and Jocelyn post roles weekly. The board pulls those into one searchable place so nothing gets buried in the feed.' },
              { icon: '🌉', style: { background: 'rgba(22,43,68,.1)', color: 'var(--color-navy)' }, title: 'Bridge Year Hub', desc: 'Apprenticeships and programs from the Bridge Year Hub are cross-listed here, tagged as Bridge Year Friendly.' },
              { icon: '👥', style: { background: 'rgba(232,168,56,.12)', color: 'var(--color-gold-dark)' }, title: 'Community submissions', desc: 'Roles submitted by the community that pass our review filter. Use the form below to suggest something we should add.' },
            ].map(s => (
